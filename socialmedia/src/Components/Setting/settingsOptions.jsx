...
const SettingsOptions = () => {
     ...
     return (
          <aside id="logo-sidebar" className="w-full xl:w-[80%] xl:p-2 xl:absolute right-0 -z-10" aria-label="Sidebar">
               <div className="h-full px-3 py-4 overflow-y-auto">
                    <ul className="font-medium">
                         <div className='text-xl md:text-3xl font-bold mb-2'>Setting</div>
                         ...
                         <Link to="/update-profile" style={{ textDecoration: "none" }} className='border-b flex items-center cursor-pointer hover:bg-slate-100 active:opacity-50 group py-2'>
                              <div className="flex items-center p-2 text-gray-900 rounded-lg group">
                                   <svg className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
