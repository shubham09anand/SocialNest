                                ...
                                <div id={index} key={index} className={`flex gap-3 ${msg.sourceId === sender_id ? 'flex-row-reverse items-end' : ''}`}>
                                    ...
                                    <div>
                                        {msg.message ? (
                                            ...
                                            <div className={`${msg.sourceId === sender_id ? 'relative space-y-3 bg-gray-400 h-fit w-fit shadow p-2 rounded-lg' : 'relativespace-y-3 bg-gray-300 shadow p-2 rounded-lg'}`}>
                                                {msg.sourceId === sender_id && (
                                                    <div className="flex items-start gap-2.5">
                                                    </div>
                                                )}
                                                    ...
                                                    (pic.type ?
                                                        (
                                                            pic.type === "image/jpeg" || pic.type === "image/jpg" || pic.type === "image/webp" || pic.type === "image/svg+xml" || pic.type === "image/AI" ?
                                                                ...
                                                                :
                                                                <div className='h-fit py-2 px-2 rounded-md bg-white' style={{ border: "solid black 1px" }}>
                                                                                                    ...
                                                                                                    : pic.type === "application/vnd.openxmlformats-officedocument.presentationml.presentation" ?
                                                                                                        ...
                                                                                                        : pic.type === "notKnown" ?
                                                                                                            ...
                                                                                                            : pic.type === "" ?
                                                                                                                ...
                                                                                                                : null}
                                                                            <div>
                                                                                <a href={pic.base64} download={`${pic.name}`} className='hover:text-black my-auto h-fit' style={{ textDecorationColor: "none" }}>
                                                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="3" stroke="currentColor" className="w-6 h-6 border-2 rounded-full p-0.5 translate-x-12" style={{ border: "solid 2px black", textDecorationColor: "none" }}>
                                                            ...
                                                            <img src={pic} className='w-[300px] md:w-96 h-64 rounded-lg my-1 object-fill' />
                                                        </div>
                                                    )
