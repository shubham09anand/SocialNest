...
const PostAniamtion = () => {
     return (
          <div>
               <div role="status" className="shadow-inner space-y-8 animate-pulse md:items-center w-full p-2">
                    <div className="pl-4 sm:pl-0 flex items-center my-4">
                         ...
                         <div>
                              <div className="h-2.5 bg-gray-500 rounded-full dark:bg-gray-700 w-32 mb-2"></div>
                              <div className="w-48 h-2 bg-gray-700 rounded-full dark:bg-gray-700"></div>
                         </div>
                    </div>
                    ...
                    <div className="w-full">
                         <div role="status" className="space-y-2.5 animate-pulse w-full">
                              ...
                              <div className="flex items-center w-full">
                                   ...
                                   <div className="h-2.5 ms-2 bg-gray-800 rounded-full dark:bg-gray-600 w-full"></div>
                              ...
                              <div className="flex items-center w-full">
                                   ...
                                   <div className="h-2.5 ms-2 bg-gray-800 rounded-full dark:bg-gray-700 w-80"></div>
                                   <div className="h-2.5 ms-2 bg-gray-600 rounded-full dark:bg-gray-600 w-full"></div>
                              </div>
