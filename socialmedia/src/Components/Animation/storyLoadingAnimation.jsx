...
const storyLoadingAnimation = () => {
     return (
          <div>
               <div className="w-full sm:w-1/2 md:w-1/3 mx-auto h-[85vh] lg:shadow-xl example relative">
                    <div className="animate-pulse w-full h-full mx-auto bg-gray-300 p-3 rounded-xl relative example">
